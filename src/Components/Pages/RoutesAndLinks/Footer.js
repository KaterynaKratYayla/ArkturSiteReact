...
console.log('[file]:import', 'import {ContentPages} from \'../PageComponents/ContentPages\'');
...
export const Footer = () => {
	console.log('[file]:export const Footer', 'src/Components/Pages/RoutesAndLinks/Footer.js');
